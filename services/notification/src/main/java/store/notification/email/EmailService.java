...
import store.notification.kafka.order.Product;
...
import static store.notification.email.EmailTemplates.ORDER_CONFIRMATION;
import static store.notification.email.EmailTemplates.PAYMENT_CONFIRMATION;
...
public class EmailService {
    ...
    public void sendPaymentSuccessEmail(String destinationEmail, String customerName, BigDecimal amount, String orderReference) throws MessagingException {
        ...
        messageHelper.setFrom("gustavoffonsec4@gmail.com");
